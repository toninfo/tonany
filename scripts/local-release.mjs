...
const packages = [
	{ directory: "packages/telemetry", name: "@tonany/pi-telemetry" },
	{ directory: "packages/ai", name: "@tonany/pi-ai" },
	{ directory: "packages/tui", name: "@tonany/pi-tui" },
	{ directory: "packages/agent", name: "@tonany/pi-agent-core" },
	{ directory: "packages/protocol", name: "@tonany/pi-protocol" },
	{ directory: "packages/client", name: "@tonany/pi-client" },
	{ directory: "packages/session-backends/sqlite-node", name: "@tonany/pi-session-backend-sqlite-node" },
	{ directory: "packages/server", name: "@tonany/pi-server" },
	{ directory: "packages/coding-agent", name: "@tonany/pi-coding-agent" },
];
