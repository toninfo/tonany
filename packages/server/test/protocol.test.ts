import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@tonany/pi-ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "@tonany/pi-protocol";
