...
import type { Transport } from "@tonany/pi-ai";
import type { TuiMode as RendererTuiMode, ScrollViewScrollbar } from "@tonany/pi-tui";
...
export interface Settings {
	...
	enableInstallTelemetry?: boolean; // tonany default: false - opt-in only; needs PI_REPORT_INSTALL_URL
