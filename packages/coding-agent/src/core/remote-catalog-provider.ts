import type { Api, Model, ModelsStoreEntry, Provider } from "@tonany/pi-ai";
...
/** 可选的远程模型目录 overlay（默认关闭，不连上游）。 */
export function withRemoteCatalog(
	provider: Provider,
	catalogBaseUrl: string = getDefaultCatalogBaseUrl(),
