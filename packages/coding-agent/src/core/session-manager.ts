...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@tonany/pi-ai";
 ...
 * Encodes cwd into a safe directory name under ~/.tonany/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.tonany/agent/sessions/<encoded-cwd>/).
	 */
