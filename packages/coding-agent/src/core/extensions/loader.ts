...
import * as _bundledPiAgentCore from "@tonany/pi-agent-core";
import type { Provider } from "@tonany/pi-ai";
import * as _bundledPiAiCompat from "@tonany/pi-ai/compat";
import * as _bundledPiAiOauth from "@tonany/pi-ai/oauth";
import * as _bundledPiAiProviders from "@tonany/pi-ai/providers/all";
import type { KeyId } from "@tonany/pi-tui";
import * as _bundledPiTui from "@tonany/pi-tui";
...
// avoiding a circular dependency. Extensions can import from @tonany/pi-coding-agent.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@tonany/pi-agent-core": _bundledPiAgentCore,
	"@tonany/pi-tui": _bundledPiTui,
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	"@tonany/pi-ai": _bundledPiAiCompat,
	"@tonany/pi-ai/compat": _bundledPiAiCompat,
	"@tonany/pi-ai/oauth": _bundledPiAiOauth,
	"@tonany/pi-ai/providers/all": _bundledPiAiProviders,
	"@tonany/pi-coding-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@tonany/pi-agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@tonany/pi-tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@tonany/pi-ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@tonany/pi-ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport("ai/dist/providers/all.js", "@tonany/pi-ai/providers/all");

	_aliases = {
		"@tonany/pi-coding-agent": piCodingAgentEntry,
		"@tonany/pi-agent-core": piAgentCoreEntry,
		"@tonany/pi-tui": piTuiEntry,
		"@tonany/pi-ai/providers/all": piAiProvidersEntry,
		"@tonany/pi-ai/compat": piAiCompatEntry,
		"@tonany/pi-ai/oauth": piAiOauthEntry,
		"@tonany/pi-ai": piAiCompatEntry,
