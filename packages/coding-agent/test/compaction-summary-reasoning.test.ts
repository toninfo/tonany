...
import type { AssistantMessage, Context, Model } from "@tonany/pi-ai";
...
vi.mock("@tonany/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@tonany/pi-ai/compat")>();
	return {
		...actual,
