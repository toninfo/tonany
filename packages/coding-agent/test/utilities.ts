...
import type { OAuthCredentials } from "@tonany/pi-ai";
import { getModel, streamSimple } from "@tonany/pi-ai/compat";
import { builtinProviders } from "@tonany/pi-ai/providers/all";
...
// ============================================================================
// OAuth API key resolution from ~/.tonany/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".tonany", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.tonany/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.tonany/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".tonany", "agent");

/**
 * Get an AuthStorage instance backed by ~/.tonany/agent/auth.json
