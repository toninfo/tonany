...
import { Text, type TUI } from "@tonany/pi-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".tonany", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .tonany/AGENTS.md",
			hidden: "Hidden resource instructions",
			absent: undefined,
		},
		{
			title: "AGENTS.override.md",
			path: join(process.cwd(), ".tonany", "AGENTS.override.md"),
			content: "Hidden override instructions",
			compact: "read resource .tonany/AGENTS.override.md",
