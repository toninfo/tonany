...
For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @tonany/pi-coding-agent`, `yarn global remove @tonany/pi-coding-agent`, or `bun uninstall -g @tonany/pi-coding-agent`.
