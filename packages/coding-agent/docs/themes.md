...
- Built-in: `dark`, `light`
- Global: `~/.tonany/agent/themes/*.json`
- Project: `.tonany/themes/*.json` (only after the project is trusted)
...
```bash
mkdir -p ~/.tonany/agent/themes
vim ~/.tonany/agent/themes/my-theme.json
```
