...
All keyboard shortcuts can be customized via `~/.tonany/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.tonany/agent/keybindings.json`:
