...
**Source:** [`@tonany/pi-tui`](https://github.com/toninfo/tonany/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@tonany/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@tonany/pi-tui";
...
Import from `@tonany/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@tonany/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@tonany/pi-tui";
...
```typescript
import { MouseRegion } from "@tonany/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@tonany/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@tonany/pi-coding-agent";
import { Markdown } from "@tonany/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@tonany/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@tonany/pi-coding-agent";
import { DynamicBorder } from "@tonany/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@tonany/pi-tui";
...
```typescript
import { BorderedLoader } from "@tonany/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@tonany/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@tonany/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@tonany/pi-tui";
...
import { matchesKey, truncateToWidth } from "@tonany/pi-tui";
